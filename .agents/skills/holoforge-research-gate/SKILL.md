...
| Freeze or execute numerical work | [Claim-sufficiency checkpoint](../../../docs/research-gate-workflow.md#use-a-claim-sufficiency-checkpoint), the frozen contract and its declared verification controls. Freeze the claim-bearing physical decision before calculating; stop refinement once the registered evidence is sufficient. |
...
| Durable evidence milestone | [Research knowledge](../../../docs/research-gate-workflow.md#update-research-knowledge-during-the-gate) and the [knowledge template](../../../docs/templates/research-knowledge-template.md). Preserve provisional, challenged, retired, and human-reviewed states and their primary evidence. |
